...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enrypt = (Button)this.findViewById(R.id.button);
        ...
        scytale = (RadioButton)this.findViewById(R.id.ButtonScytle);
        caesar = (RadioButton)this.findViewById(R.id.ButtonCaesar);
        vigenere = (RadioButton)this.findViewById(R.id.ButtonVingeare);
        input = (EditText)this.findViewById(R.id.original);
        output = (TextView)this.findViewById(R.id.Encrypted);

        scytale.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void setColumn() {
        ...
        // set title
        alertDialogBuilder.setTitle("Column Height");
        ...
        // set dialog message
        alertDialogBuilder
                .setMessage("Please enter your column height.")
                .setCancelable(false)
    ...
    public void setOffset() {
        ...
        // set title
        alertDialogBuilder.setTitle("Shift");
        ...
        // set dialog message
        alertDialogBuilder
                .setMessage("Please enter your shift amount")
                .setCancelable(false)
                .setPositiveButton("Ok",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        temp = input.getText().toString();
